...
- `--dry-run` — preview supported bug mutations, product/user/group create/update,
  and component create/update without writing; prints the would-be payload.
...
This reference is authored against **bzr 0.10.1-dev**. If `bzr --version` is much
