...
for _phase in \
    ...
    05-fields-classifications 06-users 07-groups 08-bugs 08b-bugs-paging 08c-bugs-create-fields 08d-bug-update-from-json 08e-bugs-restricted-access \
    ...
    17-global-options 17b-arg-validation 18-completion-schema 18a-json-envelope 99-sequences; do
