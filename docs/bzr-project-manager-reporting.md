...
The [asciinema cast](assets/bzr-project-manager-reporting-demo.cast) is a deterministic demonstration
of the intended interaction: a program manager asks an agent for an analysis, and the final screen is
