...
| `add_external_tracker`, `update_external_tracker`, `remove_external_tracker` | explicit gap | RHBZ `ExternalBugs` methods are owned by open #801. | `compare/08-rhbz-externalbugs/add`, `compare/08-rhbz-externalbugs/update`, `compare/08-rhbz-externalbugs/remove` |
