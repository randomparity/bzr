...
| `add_external_tracker`, `update_external_tracker`, `remove_external_tracker` | `bug external-bug add`, `update`, `remove` | RHBZ ExternalBugs mutations use the advertised extension over XML-RPC. RHBZ `ExternalBugs` mutations are parity through `bzr bug external-bug`. | `compare/08-rhbz-externalbugs/add`, `compare/08-rhbz-externalbugs/update`, `compare/08-rhbz-externalbugs/remove` |
